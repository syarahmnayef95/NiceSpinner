...
public class NiceSpinnerAdapterWrapper extends NiceSpinnerBaseAdapter {
    ...
    public NiceSpinnerAdapterWrapper(Context context, ListAdapter toWrap, int sMenuBackGround, int menueTextColor, float menueTextSize, boolean hasLog) {
        super(context, sMenuBackGround, menueTextColor, menueTextSize, hasLog);
        mBaseAdapter = toWrap;
